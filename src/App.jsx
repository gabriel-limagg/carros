  ...
  return (
    <main className="min-h-svh bg-offwhitebg py-20 px-6" >
      ...
      <div className="bg-orange p-12 rounded-t-lg">
        <img src={iconSedan} alt="" className="mb-7"/>
            ...
            <p className="font-lexend mb-7">Escolha um sedan pelo seu preço acessível e excelente economia de combustível. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
              <a className="font-lexend mb-7" href="https://www.webmotors.com.br/sedans/carros/estoque?tipoveiculo=carros&necessidade=Sedans" target="_blank">ver mais</a>
      </div>
      ...
      <div className="bg-green p-12 ">
            ...
            <a className="font-lexend mb-7" href="https://www.webmotors.com.br/suvs" target="_blank" >ver mais</a>
      </div>
      <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend mb-7"  href="https://www.webmotors.com.br/catalogo/carroceria/coupe/" target="_blank">ver mais</a>
      </div>
      </section>
    </main>
  )
